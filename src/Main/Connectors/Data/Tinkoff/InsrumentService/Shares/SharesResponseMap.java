package Main.Connectors.Data.Tinkoff.InsrumentService.Shares;
...
public class SharesResponseMap extends Mapping {
    ...
    public String[] getAllNamesByCountryOfRisk(String countryName) {
        List<String> listOfNames = new ArrayList<>();
        for (int i = 0; i < this.instruments.length; i++) {
            if (this.instruments[i].getCountryOfRisk().equalsIgnoreCase(countryName)) {
                listOfNames.add(this.instruments[i].getName());
            }
        }
        String[] arrayOfNames = new String[listOfNames.size()];
